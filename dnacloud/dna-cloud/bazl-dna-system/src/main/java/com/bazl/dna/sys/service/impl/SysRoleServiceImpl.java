...
public class SysRoleServiceImpl implements ISysRoleService {
	...
	@Autowired
	private ISysRoleJPADao roleDao;

	@Autowired
	private ISysRoleMenuJPADao roleMenuDao;

	@Autowired
	private ISysRoleMenuOperJPADao roleMenuOperDao;

	@Autowired
	private ISysUserRoleJPADao userRoleDao;
