...
public class SystemTask {
	...
	@Autowired
	private IScheduleTaskMQService scheduleTaskMQService;
	...
	public void taskRun(InvokeParam param) {
		...
		scheduleTaskMQService.pullTask(JSON.toJavaObject(JSON.parseObject(JSON.toJSONString(param)),InvokeParamDto.class));
	}
}
