...
public class ExportExcelUtils {
	...
	public static void exportExcel(String fileName, String[] columnName,
		...
		try (Workbook workbook = exportExcel(fileName, DataUtils.getFileName(fileName), columnName, titleKey, dataList);
				FileOutputStream fileOut = new FileOutputStream(new File(filePath + File.separator + fileName))) {
	 ...
	 */
	public static void exportExcel(String fileName, String[] columnName,
			String[] titleKey, Map<String, List<?>> mapList, String filePath) {

		String extension = DataUtils.getExtension(fileName);
		try (Workbook workbook = createWorkbook(extension);
				FileOutputStream fileOut = new FileOutputStream(new File(filePath + File.separator + fileName));) {
	...
	private static void export(Workbook workbook, String sheetName, String[] columnName,
		...
		try {
			...
			// 设置标题单元格和内容单元格样式
			CellStyle titleCellStyle = buildCellStyleForTitle(workbook, IndexedColors.PALE_BLUE);
	 ...
	 * 构造单元格样式-标题
	 * @param workbook	工作薄
	 * @param colors    IndexedColors
	 * @return 单元格样式
	 */
	private static CellStyle buildCellStyleForTitle(Workbook workbook, IndexedColors colors) {
		CellStyle style = workbook.createCellStyle();
