...
public class SysTaskLog implements Serializable {
	...
	/** 日志信息 */
	@Column(name = "task_message", nullable = true, length = 500)
	 ...
	 *	执行任务服务ip
	 */
	@Column(name = "execute_ip", nullable = true, length = 64)
	private String executeIp;
	
	/** 
	 *	执行任务服务名称
	 */
	@Column(name = "execute_server_name", nullable = true, length = 64)
