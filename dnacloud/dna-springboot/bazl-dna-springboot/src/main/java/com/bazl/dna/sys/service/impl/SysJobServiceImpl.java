...
public class SysJobServiceImpl implements ISysJobService {
    ...
    public Page<SysJob> pageList(JSONObject paramJson) {
        try {
            ...
            return jobJPADao.findAll(getCriteria(paramJson), pageable);
        } catch (Exception e) {
    ...
    public List<SysJob> findList(JSONObject paramJson) {
        ...
        return jobJPADao.findAll(criteria, Sort.by(SysConstants.JOB_ORDER));
    }
    ...
    public SysJob getById(String id) {
        try {
            Optional<SysJob> optional = jobJPADao.findById(id);
