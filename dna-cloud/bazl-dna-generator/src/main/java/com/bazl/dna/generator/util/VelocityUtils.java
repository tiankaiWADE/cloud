...
public class VelocityUtils {
	...
	public static String getFileName(String template, GenTable genTable) {
		...
		String javaPath = PROJECT_PATH + FILE_DELIMITER + StringUtils.replace(packageName, ".", FILE_DELIMITER);
		String mybatisPath = MYBATIS_PATH + FILE_DELIMITER + moduleName;
		String vuePath = "vue";
	...
	public static String getParentMenuId(JSONObject paramsObj) {
		if (!Objects.isNull(paramsObj) && !paramsObj.isEmpty() && paramsObj.containsKey(GenConstants.PARENT_MENU_ID)) {
