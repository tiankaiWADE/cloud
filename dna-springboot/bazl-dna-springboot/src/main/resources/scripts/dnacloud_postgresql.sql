...
INSERT INTO "public"."nt_sys_menu_type" VALUES ('4028e5917365edc4017365efa54d0000', '222', '22', '1', '2020-07-19 00:00:00', '2020-07-19 00:00:00');
COMMIT;
...
INSERT INTO "public"."nt_sys_role" VALUES ('ff80808172a624c00172a67c70c30007', '3333', '警员', '一般警员', '0', '2020-06-12 11:04:33', '2020-09-18 22:47:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO "public"."nt_sys_task" VALUES ('8a818b3774bef2910174bef387ec0000', 'DEFAULT', '测试system任务', '1', '{"taskId": "8a818b3774bef2910174bef387ec0000", "taskParam": {}, "concurrent": "1", "taskServerName": "bazl-dna-system"}', '0/10 * * * * ?', 'systemTask.taskRun()', '0', '', '1', '0', NULL, 'liutao', NULL);
INSERT INTO "public"."nt_sys_task" VALUES ('ff80808175cfe8900175d012ecc00002', 'DEFAULT', '错误的任务', '1', '{"taskId": "ff80808175cfe8900175d012ecc00002", "taskParam": {}, "concurrent": "1", "taskServerName": null}', '0 0 1 * * ?', 'systemTask.taskRun()', '3', NULL, NULL, '0', NULL, 'admin', NULL);
INSERT INTO "public"."nt_sys_task" VALUES ('ff80808175d015c90175d05958e50001', 'DEFAULT', '测试monitor任务', '1', '{"taskId": "ff80808175d015c90175d05958e50001", "taskParam": {}, "concurrent": "1", "taskServerName": "bazl-dna-monitor"}', '0 0 1 * * ?', 'systemTask.taskRun()', '3', NULL, '1', '0', NULL, 'admin', NULL);
...
CREATE TABLE "public"."nt_sys_fastdfs_file" (
  ...
  "file_suffix" varchar(8) COLLATE "pg_catalog"."default",
  "file_size" varchar(64) COLLATE "pg_catalog"."default",
  "fastdfs_url" varchar(255) COLLATE "pg_catalog"."default",
  "is_directory" char(1) COLLATE "pg_catalog"."default",
  "create_time" timestamp(6)
)
;
...
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."id" IS '主键';
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."file_name" IS '文件名称';
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."display_name" IS '显示名称';
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."file_path" IS '文件路径';
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."file_suffix" IS '文件后缀';
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."file_size" IS '文件长度';
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."fastdfs_url" IS '文件地址';
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."is_directory" IS '是否目录';
COMMENT ON COLUMN "public"."nt_sys_fastdfs_file"."create_time" IS '创建时间';
COMMENT ON TABLE "public"."nt_sys_fastdfs_file" IS '文件信息表';
-- ----------------------------
-- Records of nt_sys_fastdfs_file
-- ----------------------------
BEGIN;
INSERT INTO "public"."nt_sys_fastdfs_file" VALUES ('group1/M00/00/00/wKhlgl711DCAVEQWAAAEQwL8sw0614.txt', 'wKhlgl711DCAVEQWAAAEQwL8sw0614.txt', '123.txt', 'http://192.168.101.130/group1/M00/00/00/wKhlgl711DCAVEQWAAAEQwL8sw0614.txt', 'txt', '1.1 KB', 'http://192.168.101.130', '0', '2021-02-22 16:52:55');
INSERT INTO "public"."nt_sys_fastdfs_file" VALUES ('group1/M00/00/00/wKhlgl71yDKAHZxUAAeFJC8wk5A780.jpg', 'wKhlgl71yDKAHZxUAAeFJC8wk5A780.jpg', '3242.jpg', 'http://192.168.101.130/group1/M00/00/00/wKhlgl71yDKAHZxUAAeFJC8wk5A780.jpg', 'jpg', '481 KB', 'http://192.168.101.130', '0', '2021-02-22 16:53:56');
INSERT INTO "public"."nt_sys_fastdfs_file" VALUES ('group1/M00/00/00/wKhlgl72iyaAT0A6AAfMRhRFRow323.pdf', 'wKhlgl72iyaAT0A6AAfMRhRFRow323.pdf', '456.pdf', 'http://192.168.101.130/group1/M00/00/00/wKhlgl72iyaAT0A6AAfMRhRFRow323.pdf', 'pdf', '499 KB', 'http://192.168.101.130', '0', '2021-02-22 16:50:24');
COMMIT;
