...
-- ----------------------------
BEGIN;
INSERT INTO `nt_sys_job` VALUES ('1', '研发部', '管理员', NULL, NULL, 1, '1', '1', '2020-04-24 14:31:41', '2021-01-13 17:26:59');
...
INSERT INTO `nt_sys_menu_type` VALUES ('3', 'nt_database', 'DNA数据库比对管理系统', '0', '2013-01-01 10:00:00', '2013-01-01 10:00:00');
...
-- ----------------------------
BEGIN;
INSERT INTO `nt_sys_role` VALUES ('1', '22222222', '超管', '权限最大用户', '1', '2018-10-10 16:08:02', '2021-02-07 17:16:00');
INSERT INTO `nt_sys_role` VALUES ('ff80808172a150110172a159d9c40000', '1591844919746', '职员', '普通用户', '1', '2020-06-11 11:08:40', '2021-01-26 15:10:04');
...
-- ----------------------------
BEGIN;
INSERT INTO `nt_sys_task`(`id`, `task_group`, `task_name`, `concurrent`, `invoke_param`, `cron_expression`, `invoke_target`, `misfire_policy`, `remark`, `execute_status`, `status`, `create_time`, `create_user`, `update_time`) VALUES ('8a818b3774bef2910174bef387ec0000', 'DEFAULT', '测试system任务', '1', '{"taskId": "8a818b3774bef2910174bef387ec0000", "taskParam": {}, "concurrent": "1", "taskServerName": "bazl-dna-system"}', '0/10 * * * * ?', 'systemTask.taskRun()', '0', '', '1', '0', NULL, 'liutao', NULL);
INSERT INTO `nt_sys_task`(`id`, `task_group`, `task_name`, `concurrent`, `invoke_param`, `cron_expression`, `invoke_target`, `misfire_policy`, `remark`, `execute_status`, `status`, `create_time`, `create_user`, `update_time`) VALUES ('ff80808175cfe8900175d012ecc00002', 'DEFAULT', '错误的任务', '1', '{"taskId": "ff80808175cfe8900175d012ecc00002", "taskParam": {}, "concurrent": "1", "taskServerName": null}', '0 0 1 * * ?', 'systemTask.taskRun()', '3', NULL, NULL, '0', NULL, 'admin', NULL);
INSERT INTO `nt_sys_task`(`id`, `task_group`, `task_name`, `concurrent`, `invoke_param`, `cron_expression`, `invoke_target`, `misfire_policy`, `remark`, `execute_status`, `status`, `create_time`, `create_user`, `update_time`) VALUES ('ff80808175d015c90175d05958e50001', 'DEFAULT', '测试monitor任务', '1', '{"taskId": "ff80808175d015c90175d05958e50001", "taskParam": {}, "concurrent": "1", "taskServerName": "bazl-dna-monitor"}', '0 0 1 * * ?', 'systemTask.taskRun()', '3', NULL, '1', '0', NULL, 'admin', NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `nt_sys_user` VALUES ('1', 'admin', 'C4CA4238A0B923820DCC509A6F75849B', '超管', 'https://www.oner365.com/group1/M00/00/04/rBqcll9Qsc-ADt_9AAAk7-agPWw680.jpg', '0', '1', 'admin@qq.com', '110103197707250933', '127.0.0.1', '2021-01-13 17:27:15', '13800138000', '', 'beijing', '1', '12345', '1', '1', '123456', '2018-10-09 14:19:44');
...
INSERT INTO `nt_sys_user_job` VALUES ('ff80808176fb0ca60176fb1215560002', 1, '1', '2021-01-13 17:27:15', NULL, '1', '1');
COMMIT;
...
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb12155d0003', 1, '1', '2021-01-13 17:27:15', NULL, '3', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb1215600004', 1, '1', '2021-01-13 17:27:15', NULL, '4', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb1215630005', 1, '1', '2021-01-13 17:27:15', NULL, '110101', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb1215650006', 1, '1', '2021-01-13 17:27:15', NULL, '110102', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb1215670007', 1, '1', '2021-01-13 17:27:15', NULL, '110105', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb12156a0008', 1, '1', '2021-01-13 17:27:15', NULL, '14', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb12156c0009', 1, '1', '2021-01-13 17:27:15', NULL, '15', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb12156f000a', 1, '1', '2021-01-13 17:27:15', NULL, '16', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb121572000b', 1, '1', '2021-01-13 17:27:15', NULL, '2', '1');
INSERT INTO `nt_sys_user_org` VALUES ('ff80808176fb0ca60176fb121575000c', 1, '1', '2021-01-13 17:27:15', NULL, '13', '1');
COMMIT;
...
INSERT INTO `nt_sys_user_role` VALUES ('ff80808176fb0ca60176fb12154c0000', '1', '1');
INSERT INTO `nt_sys_user_role` VALUES ('ff80808176fb0ca60176fb12154f0001', 'ff80808172a150110172a159d9c40000', '1');
COMMIT;
