package com.bazl.dna.hadoop.controller;
...
import com.bazl.dna.hadoop.config.ResponseData;
import com.bazl.dna.hadoop.entity.User;
import com.bazl.dna.hadoop.service.HdfsService;
...
public class HdfsController {
	 ...
	 */
	@GetMapping("/mkdir")
	public ResponseData mkdir(@RequestParam("path") String path) {
	...
	public ResponseData readPathInfo(@RequestParam("path") String path) {
	...
	public ResponseData getFileBlockLocations(@RequestParam("path") String path) {
		try (FileSystem fs = HdfsService.getFileSystem();) {
	...
	public ResponseData createFile(@RequestParam("path") String path, @RequestParam("file") MultipartFile file) {
		try (FileSystem fs = HdfsService.getFileSystem();) {
	 ...
	 */
	@GetMapping("/readFile")
	public ResponseData readFile(@RequestParam("path") String path) {
		String result = null;
		try (FileSystem fs = HdfsService.getFileSystem();) {
	...
	public ResponseData openFileToBytes(@RequestParam("path") String path) {
		byte[] result = null;
		try (FileSystem fs = HdfsService.getFileSystem();) {
	...
	public ResponseData openFileToUser(@RequestParam("path") String path) {
		User result = null;
		try (FileSystem fs = HdfsService.getFileSystem();) {
	 ...
	 */
	@GetMapping("/listFile")
	public ResponseData listFile(@RequestParam("path") String path) {
	...
	public ResponseData renameFile(@RequestParam("oldName") String oldName, @RequestParam("newName") String newName) {
		boolean result = false;
		try (FileSystem fs = HdfsService.getFileSystem();) {
	...
	public ResponseData deleteFile(@RequestParam("path") String path) {
		boolean result = false;
		try (FileSystem fs = HdfsService.getFileSystem();) {
	...
	public ResponseData uploadFile(@RequestParam("path") String path, @RequestParam("uploadPath") String uploadPath) {
		try (FileSystem fs = HdfsService.getFileSystem();) {
	...
	public ResponseData downloadFile(@RequestParam("path") String path,
	 ...
	 */
	@GetMapping("/copyFile")
	public ResponseData copyFile(@RequestParam("sourcePath") String sourcePath,
	...
	public ResponseData existFile(@RequestParam("path") String path) {
		boolean result = false;
		try (FileSystem fs = HdfsService.getFileSystem();) {
