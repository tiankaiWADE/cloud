package com.bazl.dna.common.cache.aspect;
...
import com.bazl.dna.common.cache.annotation.RedisCacheEvict;
...
public class RedisCacheAspect {
	...
	@Pointcut("@annotation(com.bazl.dna.common.cache.annotation.RedisCachePut)")
	public void annotationPut() {
		// RedisCachePut
	}

	@Pointcut("@annotation(com.bazl.dna.common.cache.annotation.RedisCacheAble)")
	public void annotationAble() {
		// RedisCacheAble
	}

	@Pointcut("@annotation(com.bazl.dna.common.cache.annotation.RedisCacheEvict)")
