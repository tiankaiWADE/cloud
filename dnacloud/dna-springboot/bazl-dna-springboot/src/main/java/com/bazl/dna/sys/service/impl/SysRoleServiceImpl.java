...
public class SysRoleServiceImpl implements ISysRoleService {
    ...
    public Page<SysRole> pageList(JSONObject paramJson) {
        try {
            ...
            return roleJPADao.findAll(getCriteria(paramJson), pageable);
        } catch (Exception e) {
    ...
    public List<SysRole> findList(JSONObject paramJson) {
        ...
        return roleJPADao.findAll(criteria);
    }
    ...
    public SysRole getById(String id) {
        try {
            Optional<SysRole> optional = roleJPADao.findById(id);
    ...
    public int deleteById(String id) {
        ...
        // 删除角色与菜单操作关联
        roleMenuOperJPADao.deleteRoleMenuOperByRoleId(id);
        // 删除角色与菜单关联
        roleMenuJPADao.deleteRoleMenuByRoleId(id);
        // 删除角色
    ...
    public int saveAuthority(String menuType, JSONArray menuIds, String roleId) {
        roleMenuJPADao.deleteRoleMenuByRoleId(roleId);
