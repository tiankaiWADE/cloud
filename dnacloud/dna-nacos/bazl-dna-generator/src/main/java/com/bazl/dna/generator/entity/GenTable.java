package com.bazl.dna.generator.entity;
	...
	public static boolean isSuperColumn(String tplCategory, String javaField) {
		...
		if (isTree(tplCategory)) {
			return StringUtils.equalsAnyIgnoreCase(javaField,
					ArrayUtils.addAll(GenTable.TREE_ENTITY, GenTable.BASE_ENTITY));
		}
		return StringUtils.equalsAnyIgnoreCase(javaField, GenTable.BASE_ENTITY);
	}
