 ...
 * @author zhaoyong
 */
@FeignClient(value = "bazl-dna-monitor", fallback = MonitorServiceClientFallback.class, configuration = FeignSupportConfig.class)
public interface IMonitorServiceClient {
	...
	ResponseData getInfo(@PathVariable("id") String id);
